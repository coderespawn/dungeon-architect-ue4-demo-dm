...
static const FString MapNames[] = { TEXT("HellForge") };
static const FString JoinMapNames[] = { TEXT("Any"), TEXT("Hell Forge") };
static const FName PackageNames[] = { TEXT("HellForge.umap") };
...
FShooterMainMenu::EMap FShooterMainMenu::GetSelectedMap() const
{
	...
	return EMap::EHellForge;	// Need to return something (we can hit this path in cooking)
}
